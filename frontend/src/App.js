...
import Navbar from './pages/CartNavbar';
import CartDescription from './pages/Cartdescription';
  ...
  return (
    <Router>
      <div className="App">
        ...
        <Routes>
  <Route path="/cart-description" element={<CartDescription cartItems={cartItems} />} />
